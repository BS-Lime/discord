    ...
    if (oldState.channelID != null) {
      ...
      voiceRoles.forEach((voiceRole) => {
        user = oldState.member
          ...
          console.log('Removed ' + voiceRole.roleId + ' from ' + user + ' in ' + oldState.channelID + " on " + oldState.guild.id)
      })
    }
    ...
    if (newState.channelID != null) {
      ...
      voiceRoles.forEach((voiceRole) => {
        user = newState.member
          ...
          console.log('Added ' + voiceRole.roleId + ' to ' + user + ' in ' + oldState.channelID + ' on ' + oldState.guild.id)
      })
    }
